 ...
 * @author btssio
 */
public class VueCR extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueCR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
